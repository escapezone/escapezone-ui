...
const OutlineInputStyle = styled(OutlinedInput, { shouldForwardProp })(({ theme }) => ({
	...
	paddingLeft: 16,
	paddingRight: 16,
	'& input': { background: 'transparent !important', paddingLeft: '4px !important' },
	[theme.breakpoints.down('lg')]: { width: '225%' },
	[theme.breakpoints.down('md')]: { width: '100%', marginLeft: 4, background: '#fff' }
}));
